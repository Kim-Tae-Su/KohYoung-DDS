...
from KYITopics.DdsGrabberReinitStart import * 
...
class CGrabberReinitStartParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsGrabberReinitStartHandler(self)
    ...
    def updateDdsData(self, domain, topic, cmd, year, month, day, hour, minute, seconds, millisconds, \
        ...
        try:
            ...
            self.add_data(data)
            # thread에서 data를 export할 수 있게 event set 한다
