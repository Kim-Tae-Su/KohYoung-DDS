...
from MCSTopics.PCBStatus.DDS_PCB_OUT_NEXT_DONE_STATUS import * 
...
class CPcbOutNextDoneStatusParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsPcbOutNextDoneStatusHandler(self)
