...
from MCSTopics.PCBStatus.DDS_PCB_OUTLET_PASSING import * 
...
class CPcbOutletPassingParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsPcbOutletPassingHandler(self)
