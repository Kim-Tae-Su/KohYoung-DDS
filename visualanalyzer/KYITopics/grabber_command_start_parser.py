...
import sys, os
visualanalyzerPath = os.path.join(os.path.dirname(os.path.abspath(os.path.dirname(__file__))), 'visualanalyzer')
sys.path.insert(0, visualanalyzerPath)
...
from KYITopics.DdsGrabberCommandStart import * 
...
class CGrabberCommandStartParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsGrabberCommandStartHandler(self)
