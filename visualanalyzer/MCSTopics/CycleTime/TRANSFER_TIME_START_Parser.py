...
from MCSTopics.CycleTime.DDS_TRANSFER_TIME_START import * 
...
class CTransferStartParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsTransferStartHandler(self)
