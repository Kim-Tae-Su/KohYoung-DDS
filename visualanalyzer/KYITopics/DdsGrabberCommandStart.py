...
class DdsGrabberCommandStartHandler(KyiTopic):
    ...
    def __init__(self, dataParser):
        ...
        try:            
            ...
            self.userName = "GrabberCommandStart"
            self.topicName = "GrabberCommandStart"            
    ...
    def parseAndUpdate(self):
        ...
        msg = ""
        try:
            if self.recvCommand == "GrabberCommandStart":
