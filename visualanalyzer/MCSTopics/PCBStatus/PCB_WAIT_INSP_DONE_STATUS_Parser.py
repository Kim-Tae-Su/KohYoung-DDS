...
from MCSTopics.PCBStatus.DDS_PCB_WAIT_INSP_DONE_STATUS import * 
...
class CPcbWaitInspDoneStatusParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsPcbWaitInspDoneStatusHandler(self)
