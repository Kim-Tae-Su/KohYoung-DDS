...
from MCSTopics.PCBStatus.DDS_PCB_ENTRY_PASSED_INCOME_PASSING import * 
...
class CPcbEntryPassedIncomePassingParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsPcbEntryPassedIncomePassingHandler(self)
