...
from MCSTopics.PCBStatus.DDS_PCB_INSP_DONE_STATUS import * 
...
class CPcbInspDoneStatusParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsPcbInspDoneStatusHandler(self)
