...
from MCSTopics.PCBStatus.DDS_PCB_OUT_NEXT_STATUS import * 
...
class CPcbOutNextStatusParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsPcbOutNextStatusHandler(self)
