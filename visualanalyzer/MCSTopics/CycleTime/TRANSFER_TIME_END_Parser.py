...
from MCSTopics.CycleTime.DDS_TRANSFER_TIME_END import * 
...
class CTransferEndParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsTransferEndHandler(self)
