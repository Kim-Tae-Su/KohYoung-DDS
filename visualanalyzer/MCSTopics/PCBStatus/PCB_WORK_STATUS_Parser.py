...
from MCSTopics.PCBStatus.DDS_PCB_WORK_STATUS import * 
...
class CPcbWorkStatusParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsPcbWorkStatusHandler(self)
