...
from KYITopics.DdsGrabberEnd import * 
...
class CGrabberEndParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsGrabberEndHandler(self)
