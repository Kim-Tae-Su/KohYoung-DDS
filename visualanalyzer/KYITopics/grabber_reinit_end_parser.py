...
from KYITopics.DdsGrabberReinitEnd import * 
...
class CGrabberReinitEndParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsGrabberReinitEndHandler(self)
