...
from KYITopics.DdsGrabEnd import * 
...
class CGrabEndParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsGrabEndHandler(self)
    ...
    def updateDdsData(self, domain, topic, cmd, year, month, day, hour, minute, seconds, millisconds, \
        ...
        try:
            data = CGrabEndData(
                ...
                int(seqId), int(userIndex), int(float(spanTime)))
