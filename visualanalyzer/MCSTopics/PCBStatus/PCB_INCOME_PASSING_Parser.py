...
from MCSTopics.PCBStatus.DDS_PCB_INCOME_PASSING import * 
...
class CPcbIncomePassingParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsPcbIncomePassingHandler(self)
