...
from MCSTopics.CycleTime.DDS_FID_INSP_START import * 
...
class CFidInspStartParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsFidInspStartHandler(self)
