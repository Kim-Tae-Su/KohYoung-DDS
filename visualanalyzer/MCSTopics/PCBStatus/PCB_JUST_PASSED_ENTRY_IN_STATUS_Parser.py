...
from MCSTopics.PCBStatus.DDS_PCB_JUST_PASSED_ENTRY_IN_STATUS import * 
...
class CPcbJustPassedEntryInStatusParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsPcbJustPassedEntryInStatusHandler(self)
