...
from MCSTopics.PCBStatus.DDS_PCB_OUT_STATUS import * 
...
class CPcbOutStatusParser(CDataExportThread, CJasonManager):
    ...
    def initDdsHandler(self):
        ...
        msg = ""
        try:
            self._ddsHandler = DdsPcbOutStatusHandler(self)
